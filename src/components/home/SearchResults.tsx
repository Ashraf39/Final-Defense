      ...
      <div className="container mx-auto px-4 mt-4 space-y-8 bg-white rounded-lg shadow-lg border border-gray-100 p-6">
        ...
        {medicines.length > 0 && (
          <div className="w-full max-w-[1000px] mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-2 sm:px-4 justify-items-start">
              {medicines.map((medicine) => (
                <div className="w-full sm:w-[220px] sm:transform-none transform scale-40" key={medicine.id}>
                  <SearchMedicineCard
                    medicine={medicine}
